                        ...
                        match level {
                            PexLevel::Rc => {
                                match signal {
                                    ...
                                    TbSignals::ColSel(i) => format!( "N_X0/col_sel[{i}]_X0/Xcol_circuitry/Xcol_group_0/Xmux_{i}/XMNBR/M0_g"),
                                    TbSignals::ColSelB(i) => format!( "N_X0/col_sel_b[{i}]_X0/Xcol_circuitry/Xcol_group_0/Xmux_{i}/XMPBR/M0_g"),
